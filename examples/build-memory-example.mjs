...
// Verify with:  node verify.mjs examples/memory.doc.html
...
<header>
  ...
  <p class="header-meta">doc.html v0.3 · ${BUILD_DATE} · ${records.length} sections · ${totalChars.toLocaleString()} chars · self-verifying (node verify.mjs &lt;this file&gt;)</p>
